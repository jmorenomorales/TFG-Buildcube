...
namespace TouchScript.InputSources.InputHandlers
{
    ...
    /// </summary>
    public class TouchHandlerSticker : IInputSource, IDisposable
    {
        ...
        public TouchHandlerSticker(PointerDelegate addPointer, PointerDelegate updatePointer, PointerDelegate pressPointer, PointerDelegate releasePointer, PointerDelegate removePointer, PointerDelegate cancelPointer)
        {
